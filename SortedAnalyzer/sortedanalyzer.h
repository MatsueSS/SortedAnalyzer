...
private:
    ...
    QVector<double> timeWorkBSort;
    QVector<double> timeWorkISort;
    QVector<double> timeWorkHSort;
    QVector<int> lengths = {100, 200, 300, 400, 500, 750, 1000, 2500, 5000, 10000};

public:
    SortedAnalyzer();

    enum type_sort {_quick_sort = 0, _choice_sort = 1, _buble_sort = 2, _insert_sort = 3, _heap_sort = 4};
    ...
    friend void buble_sort(SortedAnalyzer* obj, int n, bool(*func)(int a, int b));
    friend void insert_sort(SortedAnalyzer* obj, int n, bool(*func)(int a, int b));
    friend void heap_sort(SortedAnalyzer* obj, int n, bool(*func)(int a, int b));
    friend void make_heap(SortedAnalyzer* obj, int n, int i, bool(*func)(int a, int b));
};
...
private:
    ...
    QPushButton* pcmdBSort {nullptr};
    QPushButton* pcmdISort {nullptr};
    QPushButton* pcmdHSort {nullptr};
